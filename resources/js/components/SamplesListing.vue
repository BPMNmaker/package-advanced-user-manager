  ...
  methods: {
      ...
      switch (action) {
        ...
        case 'remove-item':
          ProcessMaker.confirmModal(
            ...
            '',
            () => {
              ProcessMaker.apiClient.delete(`admin/advanced-user-manager/${data.id}`).then(() => {
    ...
    fetch() {
      ...
      ProcessMaker.apiClient
        .get(
          `admin/advanced-user-manager/fetch?page=${this.page}&per_page=${this.perPage}&filter=${this.filter}&order_by=${this.orderBy}&order_direction=${this.orderDirection}`,
        )
        .then((response) => {
