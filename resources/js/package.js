  ...
  methods: {
    ...
    onSubmit(evt) {
      ...
      if (this.validateForm()) {
        ...
        if (this.action === 'Add') {
          ProcessMaker.apiClient.post('admin/advanced-user-manager', {
          ...
          ProcessMaker.apiClient.patch(`admin/advanced-user-manager/${this.sample.id}`, {
            name: this.sample.name,
            status: this.sample.status,
          })
            .then(() => {
